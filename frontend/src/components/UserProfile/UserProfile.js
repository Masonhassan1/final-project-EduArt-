  ...
  async function uploadImage() {
    ...
    try {
      const res = await axios.post(
        "https://api.cloudinary.com/v1_1/dqukw0qgs/upload",
        formData
      );
  ...
  async function uploadUserImage() {
    ...
    try {
      const sendNewImage = await axios.patch(
        `http://localhost:4000/user/updateimage/${localStorage.getItem(
          "userId"
        )}`,
        userUploadImage
      );
  ...
  return (
    ...
    >
      <section className="options-list">
        <div
          className="user-my-profile user-pro-color"
        ...
        <div
          className="user-certificate user-pro-color"
      ...
      {myProfile ? (
        <section className="personal-data">
          ...
          <div className="user-photo-edit-btn">
            ...
            <input
              className="user-photo-edit-input"
              type="file"
          ...
          <div className="user-profile-color font">
            <FormattedMessage
              id="user_profile_color"
              defaultMessage="User profile color"
            />
          </div>
          <div
            id="#f684b7"
          ...
          {edit ? (
            <>
              <input
                id="user"
                className="user-name font user-profile-input"
                ref={userNameEl}
                type="text"
                placeholder={
              ...
              <div className="password-container">
                <input
                  className="user-password-input font user-profile-input"
                  type={showPassword ? "text" : "password"}
                  ref={passwordEl}
                />
                <div
                  className="user-profile-show-password"
            ...
            <>
              <div className="user-name font" onClick={noticeHandler}>
                {" "}
                {newUpdatedData.userName || userProfileData.userName}
              </div>
              <div className="user-gender font" onClick={noticeHandler}>
                {newUpdatedData.gender || userProfileData.gender || (
                  <p className="not-entered">
                    <FormattedMessage
                      id="not_entered"
              ...
              <div className="user-tel font" onClick={noticeHandler}>
                {newUpdatedData.telephoneLandLine ||
                  userProfileData.telephoneLandLine || (
                    <p className="not-entered">
                      <FormattedMessage
                        id="not_entered"
              ...
              <div className="user-password font">
                <p>#####</p>
              </div>
            </>
          )}
      ...
      {purchase ? (
        <Purchases imageData={imageData} userPurchases={userPurchases} />
      ) : (
        ""
      )}
